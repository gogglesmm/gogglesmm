...
FXIMPLEMENT(FX88598Codec,FXTextCodec,nullptr,0)
...
const FXchar* const* FX88598Codec::aliases() const {
  static const FXchar *const list[]={"iso8859-8","ISO-8859-8","ISO_8859-8","hebrew","iso-ir-138","csISOLatinHebrew",nullptr};
  return list;
  }
