...
static constexpr const FXchar * channelnames[]={
  "NA","MONO","FL","FR","FC","BL","BR","BC","SL","SR","LFE"
  };


static constexpr const FXchar * codecs[]={
  "Invalid",
  "PCM",
  "FLAC",
  "Vorbis",
...
static constexpr const FXchar * byteorders[]={
  "le",
  "be"
  };


static constexpr const FXchar * formats[]={
  "s",
  "u",
  "f",
  "iec958_frame"
...
static constexpr const FXchar * formatnames[]={
  "unknown",
  "wav",
  "ogg",
  "flac",
...
static constexpr const FXchar* gogglesmm_file_patterns =
 "All Music ("
...
static constexpr const FXchar* gogglesmm_supported_files = "*.("
#if defined(HAVE_OPUS)
  "opus,"
#endif
#if defined(HAVE_FLAC)
...
static constexpr const FXchar* gogglesmm_all_supported_files = "*.("
#if defined(HAVE_OPUS)
  "opus,"
#endif
#if defined(HAVE_FLAC)
...
extern FXString ap_get_gogglesmm_all_supported_files() {
  return gogglesmm_all_supported_files;
  }
...
extern FXString ap_get_gogglesmm_supported_files() {
  ...
  if (strlen(gogglesmm_supported_files)==3)
    return FXString::null;

  pattern = gogglesmm_supported_files;
  pattern.tail() = ')';
  return pattern;
  }
...
extern FXString ap_get_gogglesmm_filepatterns() {
  return gogglesmm_file_patterns;
  }
