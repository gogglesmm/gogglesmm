...
WavInput::WavInput(AudioEngine*e) : InputPlugin(e) {
  }

WavInput::~WavInput(){
  }

FXbool WavInput::init() {
  datasize=0;
  input_start=0;
  return true;
  }

FXbool WavInput::can_seek() const {
  return true;
  }

FXbool WavInput::seek(FXdouble pos){
...
InputStatus WavInput::process(Packet*packet) {
